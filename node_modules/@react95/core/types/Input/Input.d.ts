...
export type InputProps = InputHTMLAttributes<HTMLInputElement> & Omit<FrameProps, 'as'>;
export declare const Input: React.ForwardRefExoticComponent<React.InputHTMLAttributes<HTMLInputElement> & Omit<import("rainbow-sprinkles/dist/declarations/src/types").ChildSprinkles<{
