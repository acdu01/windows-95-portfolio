...
export type TextAreaProps = TextareaHTMLAttributes<HTMLTextAreaElement> & Omit<FrameProps, 'as'>;
export declare const TextArea: React.ForwardRefExoticComponent<React.TextareaHTMLAttributes<HTMLTextAreaElement> & Omit<import("rainbow-sprinkles/dist/declarations/src/types").ChildSprinkles<{
...
}>, "as"> & React.RefAttributes<HTMLTextAreaElement>>;
