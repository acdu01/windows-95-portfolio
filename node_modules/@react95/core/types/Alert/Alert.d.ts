...
export declare const Alert: React.ForwardRefExoticComponent<{
    id?: string;
    buttons?: Array<import("../Modal/Modal").ModalButtons>;
    menu?: Array<import("../Modal/Modal").ModalMenu>;
    dragOptions?: Omit<import("@neodrag/react").DragOptions, "handle">;
    hasWindowButton?: boolean;
    buttonsAlignment?: import("../Frame/Frame").FrameProps["justifyContent"];
    titleBarOptions?: React.ReactElement<import("../TitleBar/TitleBar").OptionReturnType> | React.ReactElement<import("../TitleBar/TitleBar").OptionReturnType>[];
} & Omit<import("rainbow-sprinkles/dist/declarations/src/types").ChildSprinkles<{
...
}>, "as"> & React.HTMLAttributes<HTMLDivElement> & Pick<import("../TitleBar/TitleBar").TitleBarBackgroundProps, "icon" | "title"> & {
    message: string;
    hasSound?: boolean;
    type?: AlertType;
