...
} & HTMLAttributes<HTMLLIElement> & Omit<FrameProps, 'as'>;
export declare const Tab: React.ForwardRefExoticComponent<{
    activeTab?: string;
    title: string;
    disabled?: boolean;
    onClick?(e: MouseEvent): void;
} & React.HTMLAttributes<HTMLLIElement> & Omit<import("rainbow-sprinkles/dist/declarations/src/types").ChildSprinkles<{
...
}>, "as"> & React.RefAttributes<HTMLLIElement>>;
