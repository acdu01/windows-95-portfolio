...
} & HTMLAttributes<HTMLOListElement> & Omit<FrameProps, 'as'>;
export declare const Tabs: React.ForwardRefExoticComponent<{
    defaultActiveTab?: string;
    children: ReactElement<TabProps> | Array<ReactElement<TabProps>>;
    onChange?(title: string, e: MouseEvent): void;
} & React.HTMLAttributes<HTMLOListElement> & Omit<import("rainbow-sprinkles/dist/declarations/src/types").ChildSprinkles<{
...
}>, "as"> & React.RefAttributes<HTMLOListElement>>;
