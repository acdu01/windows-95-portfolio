...
export type RangeProps = InputHTMLAttributes<HTMLInputElement> & Omit<FrameProps, 'as'>;
export declare const Range: React.ForwardRefExoticComponent<React.InputHTMLAttributes<HTMLInputElement> & Omit<import("rainbow-sprinkles/dist/declarations/src/types").ChildSprinkles<{
...
}>, "as"> & React.RefAttributes<HTMLInputElement>>;
