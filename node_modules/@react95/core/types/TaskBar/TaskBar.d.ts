...
} & HTMLAttributes<HTMLDivElement> & FrameProps;
export declare const TaskBar: React.ForwardRefExoticComponent<{
    list?: ReactElement<typeof List>;
} & React.HTMLAttributes<HTMLDivElement> & import("rainbow-sprinkles/dist/declarations/src/types").ChildSprinkles<{
