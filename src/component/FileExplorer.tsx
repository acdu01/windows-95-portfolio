...
const folders: FolderData[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'tutorial.doc', kind: 'doc', size: '5 KB', modified: '04/05/1998', openWindow: 'tutorial.doc' },
      { name: 'How_This_Site_Works.txt', kind: 'text', size: '7 KB', modified: '04/06/1998', openWindow: 'How_This_Site_Works.txt' },
    ],
  },
  {
    path: 'Music',
